...
st.subheader("Learn any topic interactively with AI!- Ofge")

# User Settings
st.header("⚙️ Customize Your Learning Experience")
learning_style = st.radio("Choose your learning style:", ["Text Explanation", "Diagrams", "Bullet Points", "Storytelling"])
difficulty = st.select_slider("Select difficulty level:", options=["Beginner", "Intermediate", "Advanced"])
study_pace = st.radio("Set your study pace:", ["Quick 5-minute review", "30-minute deep dive", "Full syllabus"])
